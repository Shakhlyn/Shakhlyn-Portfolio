    ...
    <section className="md:w-3/4 mx-auto">
      ...
      <div className=" mx-auto text-lg md:text-xl ">
        ...
        <p className="pt-8">
          ...
          my skillset by mastering Bootstrap, Tailwind CSS, Node JS, Express JS,
          MongoDB,Mongoose,REST API, React, Redux Toolkit, RTK Query. My thirst
          for knowledge extends beyond the MERN stack. I am also actively
          involved in version control using Git and GitHub. In addition, I have
          learned Python and have gained proficiency in Linux command lines.
          Equipped with this comprehensive stack, I successfully worked on some
          projects.
        </p>
        <p className="pt-8">
          Currently, I'm actively honing my skills in Redis and PostgreSQL,
          ...
          continuous learning and am eager to explore Django and Docker after
          learning PostgreSQL, expanding my technical toolkit for creating
          cutting-edge applications. My ultimate goal is to excel as a backend
          developer, contributing to the creation of robust and scalable
